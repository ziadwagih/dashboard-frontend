...
function hitTestItem(item, x, y) {
  if (item._internal_text !== void 0 && hitTestText(item._internal_x, item._internal_text._internal_y, item._internal_text._internal_width, item._internal_text._internal_height, x, y)) {
    return true;
  }
...
var PriceRangeImpl = class _PriceRangeImpl {
  ...
  _internal_merge(anotherRange) {
    ...
    return new _PriceRangeImpl(Math.min(this._internal_minValue(), anotherRange._internal_minValue()), Math.max(this._internal_maxValue(), anotherRange._internal_maxValue()));
  }
